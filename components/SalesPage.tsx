    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="relative bg-gradient-to-b from-blue-900 to-blue-800 text-white overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-64 opacity-60 pointer-events-none">
          <ImageWithFallback 
            src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/4391467a6a8721daf254fcd983c2d316154a73dc.avif?v=1763928332"
            alt=""
        ...
        <div className="container mx-auto px-4 py-8 md:py-16 relative">
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
            ...
            <div className="relative order-1 md:order-2 max-w-md mx-auto w-full">
              <ImageWithFallback 
                src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/15f4b3cb26c39fe064d874b5ddeae3c4249b7de1.avif?v=1763848547"
                alt="Santa with gifts and letters"
                className="w-full h-auto max-w-full"
              />
              <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6">
                <ImageWithFallback 
                  src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/746bfae136755b73d513ce560b3953332a23d797.avif?v=1763848547"
                  alt="2 Free Gifts"
          ...
          >
            {[
              ...
              },
              {
                ...
                rating: 5,
                image: "https://cdn.shopify.com/s/files/1/0711/9051/1843/files/bb7721f0837c33589c57c226d4ecd0316cd5d19a.avif?v=1763927818"
              },
              {
                name: "Michael Brown",
                text: "Best Christmas gift ever! The letter was so authentic and my son believes in Santa even more now.",
                rating: 5,
                image: "https://cdn.shopify.com/s/files/1/0711/9051/1843/files/08b1fe987506a79b3d29a7c6b7b75baf187696dc.avif?v=1763927818"
              }
            ].map((testimonial, idx) => (
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="flex justify-center">
                <img 
                  src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/15f4b3cb26c39fe064d874b5ddeae3c4249b7de1_2.avif?v=1763927948"
                  alt="Santa with gifts and letters"
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(https://cdn.shopify.com/s/files/1/0711/9051/1843/files/22f01ed5a54fa120bfa25466c69ee82ce71b629d.avif?v=1763928088)`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-6xl mx-auto mb-8 md:mb-12">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="flex justify-center">
                <img 
                  src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/725e6b4fef19b4141bd5ecabf7b8102295d2c305.avif?v=1763928149"
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex gap-3 md:gap-4 items-start md:ml-12">
                  <div className="flex-shrink-0">
                    <img 
                      src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/895057e0c7b59ea06755bc52fc66dcbf69aa3026.avif?v=1763928206"
                      alt="Letter"
                ...
                <div className="flex gap-3 md:gap-4 items-start">
                  <div className="flex-shrink-0">
                    <img 
                      src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/12386d26dbcfc7512cfcf9e075522aeca5a1e7c0.avif?v=1763928206"
                ...
                <div className="flex gap-3 md:gap-4 items-start md:ml-12">
                  <div className="flex-shrink-0">
                    <img 
                      src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/5f10839082560bfd9d362897e742915b45589285.avif?v=1763928206"
                      alt="Nice List"
                      className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 object-contain"
                    />
                  </div>
                ...
                <div className="flex gap-3 md:gap-4 items-start">
                  <div className="flex-shrink-0">
                    <img 
                      src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/2b44e2aaafb56e83f78bdf91d205eebd7f2d6e35.avif?v=1763928206"
                      alt="Envelope"
                      className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 object-contain"
                    />
                  </div>
          ...
          <div className="max-w-6xl mx-auto mt-8 md:mt-12">
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
              ...
              <div className="flex justify-center">
                <img 
                  src="https://cdn.shopify.com/s/files/1/0711/9051/1843/files/74f0addd0ea0b5525297b06c248df384ddc75c91.avif?v=1763928206"
